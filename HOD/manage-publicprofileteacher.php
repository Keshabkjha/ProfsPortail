            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Manage Professors (Public Profile)</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-Professor.php">Manage Professors (Public Profile)</a></li>
                            <li class="active">Manage Professors (Public Profile)</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Manage Professors (Public Profile)</strong>
                            </div>
                            <div class="card-body">
