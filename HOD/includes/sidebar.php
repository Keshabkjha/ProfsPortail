<aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">ProfsPortail HOD  </a>
...
<li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Professor</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-file-o"></i><a href="add-Professor.php">Add Professor</a></li>
                            <li><i class="menu-icon fa fa-file-o"></i><a href="manage-Professor.php">Manage Professor</a></li>
                        </ul>
                    </li>
